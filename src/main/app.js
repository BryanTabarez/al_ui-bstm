...
define([ 'angular',
         ...
         'tmdb/partials/helloword/HelloController'
    ...
    function( angular, config, $resource, $location, LocalStorageModule, 
              TMDBAPIService,
              HelloController
            //   SearchController, HomeController, MovieController, PersonController, 
        ...
        app.config(['$routeProvider', function($routeProvider) {
            $routeProvider.when( '/helloword', { templateUrl: '/tmdb/partials/helloword/helloword.html', controller: 'HelloController' } );
